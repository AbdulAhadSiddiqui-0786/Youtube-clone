...
export default function ChannelPage() {
  ...
  const handleDeleteChannel = async () => {
    if (!window.confirm("Are you sure you want to delete your channel?"))
      return;
          ...
          <>
            ...
            {showDescriptionPopup && (
              <div className="fixed inset-0 flex items-center justify-center bg-black/75 z-50">
                <div className="bg-gray-800 p-4 sm:p-6 rounded-lg max-w-xl w-full mx-4 relative max-h-[80vh] overflow-y-auto">
                  <IoClose
                    size={24}
            ...
            {channel?.user === user?._id && showUploadDialog && (
              <div className="fixed inset-0 flex items-center bg-black/75 justify-center z-50">
                <div className="bg-gray-800 p-4 sm:p-6 rounded-lg mb-6 max-w-xl w-full mx-4 absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
                  <IoClose
                    size={24}
                    onClick={() => setShowUploadDialog(false)}
                    className="absolute hover:text-red-500 top-4 right-4 cursor-pointer"
                  />
                  ...
                  >
                    ...
                    <option className="text-black" value="Live">
                      Live
                    </option>
                  ...
                  <input
                    ...
                    className="border-2 rounded-lg p-2 w-full cursor-pointer mb-3"
                  />
                  <input
                    type="url"
            ...
            <div className="bg-[#282828] w-[90vw] sm:w-[40rem] p-4 sm:p-6 rounded-lg shadow-lg relative">
              ...
              <div className="mt-6 flex items-center justify-end gap-4">
                ...
                <button
                  ...
                  className="px-4 py-2 rounded-md bg-blue-500 hover:bg-blue-700 text-sm sm:text-base"
                >
                  Create Channel
                </button>
              </div>
